...
//         if (!resolutionImg) return error.innerText = "Verifique o tamanho em PX da imagem."
//         if (!sizeImg) return error.innerText = "Verifique o tamanho em MB da imagem."

//         let imgPreview = field.querySelector(".container-input-img-selected #image_preview")
...
//         let acceptedFormats = field.querySelector('input').accept.replace(/\s/g, "").split(',')
