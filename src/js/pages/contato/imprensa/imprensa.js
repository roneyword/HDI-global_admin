...
const contactGroup = document.querySelector("[data-group='groupContact']");
...
onValidationDinamicInputs(contactGroup, groupContact);
...
const handleSubmite = (obj) => {
  ...
  btnSubmite.addEventListener("click", () => {
    ...
    getAllReferenceErrors(groupContact);
